...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT_split_4x6_5(
        ...
        //---------------------------------------------------------//-------------------------------------------------------//
        XXXXXXX, XXXXXXX ,KC_LBRC ,KC_LCBR ,KC_LPRN ,KC_AMPR,       KC_LNUM, KC_P7, KC_P8, KC_P9, KC_COLN, KC_UNDS,
        //---------------------------------------------------------//-------------------------------------------------------//
        XXXXXXX, K_ARROW ,KC_PSLS ,KC_PAST ,KC_PMNS ,KC_PPLS,       KC_PENT, KC_P4, KC_P5, KC_P6, XXXXXXX, KC_GRV ,
        //---------------------------------------------------------//-------------------------------------------------------//
        XXXXXXX, KC_TILD ,KC_RBRC ,KC_RCBR ,KC_RPRN, KC_PIPE,       KC_PDOT, KC_P1, KC_P2, KC_P3, KC_P0  , KC_BSLS,
        //---------------------------------------------------------//-------------------------------------------------------//
