...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAKDH] = LAYOUT_split_4x6_5(
        ...
        //-------------------------------------------------//-----------------------------------------------------------//
        KC_RALT, KC_A, KC_R, KC_S, KC_T, KC_G,              KC_M, KC_N, KC_E, KC_I, KC_O, KC_QUOT,
        //-------------------------------------------------//-----------------------------------------------------------//
        KC_LSFT, KC_Z, KC_X, KC_C, KC_D, KC_V,               KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, KC_BSLS,
        //-------------------------------------------------//-----------------------------------------------------------//
                NAV_L, KC_LGUI, KC_SPC,                          KC_ENT , KC_RSFT, NUM_L,
                        FNK_L,  KC_ENT,                          KC_RCTL, K_EMOJI
    ),
    ...
    [_NUM] = LAYOUT_split_4x6_5(
        ...
        //---------------------------------------------------------//-------------------------------------------------------//
        XXXXXXX, KC_GRV , KC_LCBR, KC_RCBR ,KC_PPLS ,XXXXXXX,       XXXXXXX, KC_P7, KC_P8, KC_P9, KC_COLN, _______,
        //---------------------------------------------------------//-------------------------------------------------------//
        KC_AMPR, K_ARROW, KC_LPRN, KC_RPRN ,KC_PMNS ,XXXXXXX,       KC_EQL , KC_P4, KC_P5, KC_P6, KC_P0  , KC_UNDS,
        //---------------------------------------------------------//-------------------------------------------------------//
        KC_PIPE, KC_TILD, KC_LBRC, KC_RBRC ,KC_PSLS ,KC_PAST,       XXXXXXX, KC_P1, KC_P2, KC_P3, KC_PDOT, KC_BSLS,
        //---------------------------------------------------------//-------------------------------------------------------//
    ...
    [_FNK] = LAYOUT_split_4x6_5(
        ...
        //---------------------------------------------------------//-------------------------------------------------------//
                XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX ,KC_LCAP,
