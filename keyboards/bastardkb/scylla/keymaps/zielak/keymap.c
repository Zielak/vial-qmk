...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAKDH] = LAYOUT_split_4x6_5(
        ...
        //-------------------------------------------------//-----------------------------------------------------------//
                NAV_L, KC_RALT, KC_SPC,                          KC_ENT , KC_RSFT, NUM_L,
    ...
    [_NUM] = LAYOUT_split_4x6_5(
        ...
        //---------------------------------------------------------//-------------------------------------------------------//
        KC_AMPR, K_ARROW, KC_LPRN, KC_RPRN ,KC_PMNS ,KC_EQL ,       XXXXXXX, KC_P4, KC_P5, KC_P6, KC_P0  , KC_UNDS,
        //---------------------------------------------------------//-------------------------------------------------------//
    ...
    [_FNK] = LAYOUT_split_4x6_5(
        ...
        //---------------------------------------------------------//-------------------------------------------------------//
                XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, KC_CAPS, KC_NUM, // TODO: see if those work on MAC
